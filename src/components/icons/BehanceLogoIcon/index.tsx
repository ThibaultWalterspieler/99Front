...
export const BehanceLogoIcon: FC<Props> = ({ className }) => {
  return (
    <svg
      className={className}
      data-iid="v-0-0-0-0-0-0-3-10-0-0"
      height="100%"
    ...
    >
      <title id="IconBase-title-v-0-0-0-0-0-0-3-10-0-0">Behance</title>
      <desc id="IconBase-description-v-0-0-0-0-0-0-3-10-0-0"></desc>
      <g>
        <g transform="translate(-55 -103)">
          ...
          ></path>
          <rect height="1.543" transform="translate(70.802 104.048)" width="6.036"></rect>
        </g>
      </g>
    </svg>
  );
